...
PG_CMDTAG(CMDTAG_LOGOUT, "LOGOUT", true, false, false)
PG_CMDTAG(CMDTAG_IDLETIMEOUT, "IDLETIMEOUT", true, false, false)
PG_CMDTAG(CMDTAG_STARTUP, "STARTUP", true, false, false)
PG_CMDTAG(CMDTAG_SHUTDOWN, "SHUTDOWN", true, false, false)
